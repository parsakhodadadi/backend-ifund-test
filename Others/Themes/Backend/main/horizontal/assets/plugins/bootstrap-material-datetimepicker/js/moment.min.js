! function (e, t) {
    ...
    var Nt = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
        Gt = "ژانویه_فوریه_مارس_آپریل_مه_ژوئن_جولای_آگوست_سپتامبر_اکتبر_نوامبر_دسامبر".split("_"),
        Vt = "ژانویه_فوریه_مارس_آپریل_مه_ژوئن_جولای_آگوست_سپتامبر_اکتبر_نوامبر_دسامبر".split("_"),
        Et = kt,
        It = kt;
    ...
    var At = "یکشنبه_دوشنبه_سه شنبه_چهارشنبه_پنج شنبه_جمعه_شنبه".split("_"),
        jt = "یکشنبه_دوشنبه_سه شنبه_چهارشنبه_پنج شنبه_جمعه_شنبه".split("_"),
        Zt = "یک_دو_سه_چه_پن_جم_شن".split("_"),
        zt = kt,
        $t = kt,
        qt = kt;
