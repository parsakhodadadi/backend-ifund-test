...
{{--                    <a href="{{ route('/Others/Themes/Frontend/Theme/') }}post-single-3.html" class="btn-link text-white fw-normal">تقویم آزمون‌های علوم پزشکی</a>--}}
...
{{--                    <a href="{{ route('/Others/Themes/Frontend/Theme/') }}post-single-3.html" class="btn-link text-white fw-normal">احتمال آغاز موج هشتم کرونا در کشور</a>--}}
{{--                    <ul class="nav nav-divider align-items-center small mt-2 text-muted">--}}
{{--                        <li class="nav-item position-relative">--}}
