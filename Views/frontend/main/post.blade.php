...
<main>
    ...
    <section class="pb-3 pb-lg-5">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <a href="#" class="badge text-bg-danger mb-2"><i class="fas fa-circle me-2 small fw-bold"></i>{{ $category->title }}</a>
                    <h1>{{ $post->title }}</h1>
                </div>
                ...
                <div class="col-lg-2">
                    <div class="text-start text-lg-center mb-5" data-sticky data-margin-top="80" data-sticky-for="991">
                        ...
                        <div class="position-relative">
                            ...
                            <a href="#" class="h5 stretched-link mt-2 mb-0 d-block">{{ $user->first_name . ' ' . $user->last_name }}</a>
                            <p>
...
{{--                    </div>--}}
                    ...
                    <div>
                        ...
                        <div class="my-4 d-flex">
                            <img class="avatar avatar-md rounded-circle float-start me-3" src="{{ route('/Others/Themes/Frontend/Theme/assets/images') }}/avatar/01.jpg" alt="avatar">
                            <div>
                                <div class="mb-2">
                        ...
                        <div class="my-4 d-flex ps-2 ps-md-3">
                            <img class="avatar avatar-md rounded-circle float-start me-3" src="{{ route('/Others/Themes/Frontend/Theme/assets/images') }}/avatar/02.jpg" alt="avatar">
                            <div>
                                <div class="mb-2">
                        ...
                        <!-- Comment level 2 -->
                        <div class="my-4 d-flex ps-2 ps-md-3">
                            <img class="avatar avatar-md rounded-circle float-start me-3" src="{{ route('/Others/Themes/Frontend/Theme/assets/images') }}/avatar/03.jpg" alt="avatar">
                            <div>
                                <div class="mb-2">
                        ...
                        <!-- Comment level 1 -->
                        <div class="my-4 d-flex">
                            <img class="avatar avatar-md rounded-circle float-start me-3" src="{{ route('/Others/Themes/Frontend/Theme/assets/images') }}/avatar/04.jpg" alt="avatar">
                            <div>
                                <div class="mb-2">
    ...
    <div class="container">
        ...
        <div class="row pt-5">
            ...
            <div class="col-md-6 col-lg-4 mb-4">
                <img class="light-mode-item" src="{{ route('/Others/Themes/Frontend/Theme/assets/images') }}/logo.svg" alt="logo">
                <img class="dark-mode-item" src="{{ route('/Others/Themes/Frontend/Theme/assets/images') }}/logo-light.svg" alt="logo">
