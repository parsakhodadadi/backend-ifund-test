...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasMenu">
    ...
    <div class="offcanvas-body d-flex flex-column pt-0">
        <div>
            <img class="light-mode-item my-3" src="{!! route('/Others/Themes/Frontend/Theme/assets') !!} ')/images/logo.svg" alt="logo">
            <img class="dark-mode-item my-3" src="{!! route('/Others/Themes/Frontend/Theme/assets') !!} ')/images/logo-light.svg" alt="logo">
            <p>موضوع وبلاگ، اخبار و مجله نسل بعدی برای شما برای شروع به اشتراک گذاری داستان های خود از امروز! </p>
            <!-- Nav START -->
            <ul class="nav d-block flex-column my-4">
                <li class="nav-item h5">
                    <a class="nav-link" href="{{ route('/Others/Themes/Frontend/Theme/') }}index.html" >خانه</a>
                <li class="nav-item h5">
                    <a class="nav-link" href="{{ route('/Others/Themes/Frontend/Theme/') }}about-us.html">درباره ما</a>
                </li>
                <li class="nav-item h5">
                    <a class="nav-link" href="{{ route('/Others/Themes/Frontend/Theme/') }}post-grid.html">خواندنی ها</a>
                </li>
                <li class="nav-item h5">
                    <a class="nav-link" href="{{ route('/Others/Themes/Frontend/Theme/') }}contact-us.html">تماس با ما</a>
                </li>
            </ul>
            <!-- Nav END -->
...
<header class="navbar-light navbar-sticky header-static">
    <div class="navbar-top d-none d-lg-block small">
        <div class="container">
            <div class="d-md-flex justify-content-between align-items-center my-2">
                ...
                <ul class="nav">
                    <li class="nav-item">
                        <a class="nav-link ps-0" href="{{ route('/Others/Themes/Frontend/Theme/') }}about-us.html">درباره ما</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('/Others/Themes/Frontend/Theme/') }}signin.html">ورود / ثبت نام</a>
                    </li>
                </ul>
                <!-- Top bar right -->
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            <!-- Logo START -->
            <a class="navbar-brand" href="{{ route('/Others/Themes/Frontend/Theme/') }}index.html">
                <img class="navbar-brand-item light-mode-item" src="{!! route('/Others/Themes/Frontend/Theme/assets') !!} ')/images/logo.svg"alt="logo">
                <img class="navbar-brand-item dark-mode-item" src="{!! route('/Others/Themes/Frontend/Theme/assets') !!} ')/images/logo-light.svg"alt="logo">
            </a>
            <!-- Logo END -->
                ...
                <ul class="navbar-nav navbar-nav-scroll mx-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="homeMenu">
                            <li> <a class="dropdown-item active" href="{{ route('/Others/Themes/Frontend/Theme/') }}index.html">نسخه 1</a></li>
                            <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}index-lazy.html">نسخه 2</a></li>
                            <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}index-3.html">نسخه 3</a></li>
                            <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}index-4.html">نسخه 4</a></li>
                            <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}index-5.html">نسخه 5</a></li>
                            <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}index-6.html">نسخه 6</a></li>
                            <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}index-7.html">نسخه 7</a></li>
                            <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}index-8.html">نسخه 8</a></li>
                            <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}index-9.html">نسخه 9</a></li>
                            <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}index-10.html">نسخه 10</a></li>
                            <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}index-11.html">نسخه 11</a></li>
                            <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}index-12.html">نسخه 12</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu"aria-labelledby="pagesMenu">
                            <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}about-us.html">درباره ما</a></li>
                            <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}contact-us.html">تماس با ما</a></li>
                            <!-- Dropdown submenu -->
                            <li class="dropdown-submenu dropend">
                                <a class="dropdown-item dropdown-toggle" href="#">فروشگاه <span class="badge bg-danger smaller me-1">جدید</span></a>
                                <ul class="dropdown-menu dropdown-menu-start"data-bs-popper="none">
                                    <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}shop-grid.html">لیست محصول <span class="badge bg-danger smaller me-1">جدید</span></a> </li>
                                    <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}shop-detail.html">جزئیات محصول</a> </li>
                                    <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}checkout.html">تسویه حساب</a> </li>
                                    <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}my-cart.html">سبد خرید</a> </li>
                                    <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}empty-cart.html">سبد خرید خالی</a> </li>
                                </ul>
                            </li>
                            <!-- Dropdown submenu -->
                            <li class="dropdown-submenu dropend">
                                ...
                                <ul class="dropdown-menu dropdown-menu-start"data-bs-popper="none">
                                    <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}author.html">نویسنده</a> </li>
                                    <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}categories.html">دسته بندی نسخه 1</a> </li>
                                    <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}categories-2.html">دسته بندی نسخه 2</a> </li>
                                    <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}tag.html"># برچسب</a> </li>
                                    <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}search-result.html">نتیجه جستجو</a> </li>
                                </ul>
                            </li>
                            <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}404.html">صفحه 404</a></li>
                            <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}signin.html">ورود</a></li>
                            <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}signup.html">ثبت نام</a></li>
                            <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}offline.html">غیرفعال</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu"aria-labelledby="postMenu">
                            ...
                            <li class="dropdown-submenu dropend">
                                ...
                                <ul class="dropdown-menu dropdown-menu-start"data-bs-popper="none">
                                    <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}post-grid.html">نسخه 1</a> </li>
                                    <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}post-grid-4-col.html">نسخه 2</a> </li>
                                    <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}post-grid-masonry.html">نسخه 3</a> </li>
                                    <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}post-grid-masonry-filter.html">نسخه 4</a> </li>
                                    <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}post-large-and-grid.html">نسخه 5</a> </li>
                                </ul>
                            </li>
                            <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}post-list.html">لیست نسخه 1</a> </li>
                            <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}post-list-2.html">لیست نسخه 2</a> </li>
                            <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}post-cards.html">لیست نسخه 3</a> </li>
                            <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}post-overlay.html">لیست نسخه 4</a> </li>
                            <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}post-types.html">لیست نسخه 5</a> </li>
                            <li class="dropdown-divider"></li>
                            <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}post-single.html">جزئیات نسخه 1</a> </li>
                            <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}post-single-2.html">جزئیات نسخه 2</a> </li>
                            <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}post-single-3.html">جزئیات نسخه 3</a> </li>
                            <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}post-single-4.html">جزئیات نسخه 4</a> </li>
                            <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}post-single-5.html">جزئیات نسخه 5</a> </li>
                            <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}post-single-6.html">جزئیات نسخه 6</a> </li>
                            <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}podcast-single.html">جزئیات نسخه 7</a> </li>
                            <li class="dropdown-divider"></li>
                            <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}pagination-styles.html">سبک های صفحه بندی</a> </li>
                        </ul>
                    </li>
                                ...
                                <div class="row g-4 p-3 flex-fill">
                                    ...
                                    <div class="col-sm-6 col-lg-3">
                                        <div class="card bg-transparent">
                                            <!-- Card img -->
                                            <img class="card-img rounded"src="{!! route('/Others/Themes/Frontend/Theme/assets') !!} ')/images/blog/16by9/small/01.jpg"alt="Card image">
                                    ...
                                    <div class="col-sm-6 col-lg-3">
                                        <div class="card bg-transparent">
                                            <!-- Card img -->
                                            <img class="card-img rounded"src="{!! route('/Others/Themes/Frontend/Theme/assets') !!} ')/images/blog/16by9/small/02.jpg"alt="Card image">
                                            <div class="card-body px-0 pt-3">
                                    ...
                                    <div class="col-sm-6 col-lg-3">
                                        <div class="card bg-transparent">
                                            <!-- Card img -->
                                            <img class="card-img rounded"src="{!! route('/Others/Themes/Frontend/Theme/assets') !!} ')/images/blog/16by9/small/03.jpg"alt="Card image">
                                            <div class="card-body px-0 pt-3">
                    ...
                    <!-- Nav item 5 link-->
                    <li class="nav-item"> <a class="nav-link" href="{{ route('/Others/Themes/Frontend/Theme/') }}dashboard.html">داشبورد</a></li>
                </ul>
            </div>
            <!-- Main navbar END -->
    ...
    <section class="pt-4 pb-0 card-grid">
        <div class="container">
            <div class="row g-4">
                <!-- Left big card -->
                <div class="col-lg-6">
                    <div class="card card-overlay-bottom card-grid-lg card-bg-scale"style="background-image:url(route('/Others/Themes/Frontend/Theme/{!! route('/Others/Themes/Frontend/Theme/assets') !!} ')/images/blog/1by1/01.jpg); background-position: center left; background-size: cover;">
                        <!-- Card featured -->
                ...
                <div class="col-lg-6">
                    <div class="row g-4">
                        <!-- Card item START -->
                        <div class="col-12">
                            <div class="card card-overlay-bottom card-grid-sm card-bg-scale"style="background-image:url(route('/Others/Themes/Frontend/Theme/{!! route('/Others/Themes/Frontend/Theme/assets') !!} ')/images/blog/1by1/02.jpg); background-position: center left; background-size: cover;">
                                <!-- Card Image -->
                                <!-- Card Image overlay -->
                                <div class="card-img-overlay d-flex align-items-center p-3 p-sm-4">
                                    <div class="w-100 mt-auto">
                        ...
                        <!-- Card item START -->
                        <div class="col-md-6">
                            <div class="card card-overlay-bottom card-grid-sm card-bg-scale"style="background-image:url(route('/Others/Themes/Frontend/Theme/{!! route('/Others/Themes/Frontend/Theme/assets') !!} ')/images/blog/1by1/03.jpg); background-position: center left; background-size: cover;">
                                <!-- Card Image overlay -->
                                <div class="card-img-overlay d-flex align-items-center p-3 p-sm-4">
                                    <div class="w-100 mt-auto">
                                        <!-- Card category -->
                        ...
                        <!-- Card item START -->
                        <div class="col-md-6">
                            <div class="card card-overlay-bottom card-grid-sm card-bg-scale"style="background-image:url(route('/Others/Themes/Frontend/Theme/{!! route('/Others/Themes/Frontend/Theme/assets') !!} ')/images/blog/1by1/04.jpg); background-position: center left; background-size: cover;">
                                <!-- Card Image overlay -->
                                <div class="card-img-overlay d-flex align-items-center p-3 p-sm-4">
                                    <div class="w-100 mt-auto">
                                        <!-- Card category -->
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <!-- Card img -->
                                <div class="position-relative">
                                    <img class="card-img"src="{!! route('/Others/Themes/Frontend/Theme/assets') !!} ')/images/blog/4by3/01.jpg"alt="Card image">
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <!-- Card img -->
                                <div class="position-relative">
                                    <img class="card-img"src="{!! route('/Others/Themes/Frontend/Theme/assets') !!} ')/images/blog/4by3/06.jpg"alt="Card image">
                                    <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                                        <!-- Card overlay Top -->
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <!-- Card img -->
                                <div class="position-relative">
                                    <img class="card-img"src="{!! route('/Others/Themes/Frontend/Theme/assets') !!} ')/images/blog/4by3/03.jpg"alt="Card image">
                                    <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                                        <!-- Card overlay bottom -->
                                        <div class="w-100 mt-auto">
                                            <!-- Card category -->
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <!-- Card img -->
                                <div class="position-relative">
                                    <img class="card-img"src="{!! route('/Others/Themes/Frontend/Theme/assets') !!} ')/images/blog/4by3/04.jpg"alt="Card image">
                                    <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                                        <!-- Card overlay bottom -->
                                        <div class="w-100 mt-auto">
                                            <!-- Card category -->
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <!-- Card img -->
                                <div class="position-relative">
                                    <!-- <img class="card-img"src="{!! route('/Others/Themes/Frontend/Theme/assets') !!} ')/images/blog/4by3/05.jpg"alt="Card image"> -->
                                            ...
                                            <div class="w-100 my-auto">
                                                ...
                                                <div class="player-wrapper bg-light rounded">
                                                    <audio class="player-audio"crossorigin>
                                                        <source src="{!! route('/Others/Themes/Frontend/Theme/assets') !!} ')/images/videos/audio.mp3"type="audio/mp3">
                                                    </audio>
                                                </div>
                                                <!-- Audio END -->
                                            </div>
                                    ...
                                    <ul class="nav nav-divider align-items-center d-none d-sm-inline-block">
                                        <li class="nav-item">
                                            <div class="nav-link">
                                                <div class="d-flex align-items-center position-relative">
                                                    <div class="avatar avatar-xs">
                                                        <img class="avatar-img rounded-circle"src="{!! route('/Others/Themes/Frontend/Theme/assets') !!} ')/images/avatar/05.jpg"alt="avatar">
                                                    </div>
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <!-- Card img -->
                                <div class="position-relative">
                                    <img class="card-img"src="{!! route('/Others/Themes/Frontend/Theme/assets') !!} ')/images/blog/4by3/12.jpg"alt="Card image">
                                    <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                                        <!-- Card overlay bottom -->
                                        <div class="w-100 mt-auto">
                                            <!-- Card category -->
                                    ...
                                    <ul class="nav nav-divider align-items-center d-none d-sm-inline-block">
                                        <li class="nav-item">
                                            <div class="nav-link">
                                                <div class="d-flex align-items-center position-relative">
                                                    <div class="avatar avatar-xs">
                                                        <img class="avatar-img rounded-circle"src="{!! route('/Others/Themes/Frontend/Theme/assets') !!} ')/images/avatar/06.jpg"alt="avatar">
                                                    </div>
                ...
                <div class="col-lg-3 mt-5 mt-lg-0">
                    <div data-sticky data-margin-top="80"data-sticky-for="767">
                        ...
                        <div>
                            ...
                            <!-- Category item -->
                            <div class="text-center mb-3 card-bg-scale position-relative overflow-hidden rounded bg-dark-overlay-4 "style="background-image:url(route('/Others/Themes/Frontend/Theme/{!! route('/Others/Themes/Frontend/Theme/assets') !!} ')/images/blog/4by3/01.jpg); background-position: center left; background-size: cover;">
                                <div class="p-3">
                                    <a  href="#"class="stretched-link btn-link text-white h5">گردشگری</a>
                                </div>
                            </div>
                            <!-- Category item -->
                            <div class="text-center mb-3 card-bg-scale position-relative overflow-hidden rounded"style="background-image:url(route('/Others/Themes/Frontend/Theme/{!! route('/Others/Themes/Frontend/Theme/assets') !!} ')/images/blog/4by3/02.jpg); background-position: center left; background-size: cover;">
                                <div class="bg-dark-overlay-4 p-3">
                                    <a  href="#"class="stretched-link btn-link text-white h5">اقتصاد</a>
                                </div>
                            </div>
                            <!-- Category item -->
                            <div class="text-center mb-3 card-bg-scale position-relative overflow-hidden rounded"style="background-image:url(route('/Others/Themes/Frontend/Theme/{!! route('/Others/Themes/Frontend/Theme/assets') !!} ')/images/blog/4by3/03.jpg); background-position: center left; background-size: cover;">
                                <div class="bg-dark-overlay-4 p-3">
                                    <a  href="#"class="stretched-link btn-link text-white h5">فرهنگ</a>
                                </div>
                            </div>
                            <!-- Category item -->
                            <div class="text-center mb-3 card-bg-scale position-relative overflow-hidden rounded"style="background-image:url(route('/Others/Themes/Frontend/Theme/{!! route('/Others/Themes/Frontend/Theme/assets') !!} ')/images/blog/4by3/04.jpg); background-position: center left; background-size: cover;">
                                <div class="bg-dark-overlay-4 p-3">
                                    <a  href="#"class="stretched-link btn-link text-white h5">تکنولوژی</a>
                                </div>
                            </div>
                            <!-- Category item -->
                            <div class="text-center mb-3 card-bg-scale position-relative overflow-hidden rounded"style="background-image:url(route('/Others/Themes/Frontend/Theme/{!! route('/Others/Themes/Frontend/Theme/assets') !!} ')/images/blog/4by3/05.jpg); background-position: center left; background-size: cover;">
                                <div class="bg-dark-overlay-4 p-3">
...
<footer class="bg-dark pt-5">
    <div class="container">
        ...
        <div class="row pt-3 pb-4">
            <div class="col-md-3">
                <img src="{!! route('/Others/Themes/Frontend/Theme/assets') !!} ')/images/logo-footer.svg"alt="footer logo">
            </div>
            <div class="col-md-5">
        ...
        <div class="row pt-5">
            ...
            <div class="col-sm-6 col-lg-3 mb-4">
                ...
                <div class="row g-2">
                    <div class="col">
                        <a  href="#"><img class="w-100" src="{!! route('/Others/Themes/Frontend/Theme/assets') !!} ')/images/app-store.svg"alt="app-store"></a>
                    </div>
                    <div class="col">
                        <a  href="#"><img class="w-100" src="{!! route('/Others/Themes/Frontend/Theme/assets') !!} ')/images/google-play.svg"alt="google-play"></a>
                    </div>
                </div>
            </div>
        </div>
