        ...
        <div class="container">
            <div class="row g-4 align-items-center justify-content-between pb-lg-5">
                <div class="col-lg-6 mt-0 position-relative">
                    <!-- Hero image -->
                    <img class="rounded"
                         src="{{ route('/Others/Themes/Frontend/Theme/assets/images') }}/blog/1by1/12.jpg" alt="">
                    <!-- Hero info -->
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-5">
                                    <div class="position-relative">
                                        <img class="rounded-3" src="{{ route('/') . $episode->photo }}"
                                             alt="Card image">
                                    </div>
                                </div>
                                <div class="col-md-7">
                                    ...
                                    <!-- Title -->
                                    <h4 class="card-title">
                                        <a href="{{ route('/podcasts/') . $episode->id }}"
                                           class="btn-link text-reset">{{ $episode->title }}</a>
                                    </h4>
                                    <!-- Author info -->
                                    <div class="d-flex align-items-center position-relative">
                                        <div class="avatar avatar-xs me-2">
                                            <img class="avatar-img  rounded-circle"
                                                 src="{{ route('/') . current($users->get(['id' => $episode->user_id]))->photo }}"
                                                 alt="avatar">
                                        </div>
                                        <h6 class="mb-0"><a href="#"
                                                            class="stretched-link text-reset btn-link">{{ current($users->get(['id' => $episode->user_id]))->first_name . ' ' . current($users->get(['id' => $episode->user_id]))->last_name }}</a>
                                        </h6>
                                    </div>
                                    <!-- Play Episode -->
                                    <div class="d-xl-flex align-items-center justify-content-between mt-4">
                                        <a class="btn btn-sm btn-primary"
                                           href="{{ route('/podcasts/') . $episode->id }}">پخش</a>
