                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-7">
                                    <div class="d-flex justify-content-between mb-2">
                                        <!-- Episode -->
                                        <a href="podcast-single.html" class="badge text-bg-danger mb-2"> قسمت{{ $episodeNum }}</a>
                                    ...
                                    <div class="d-flex align-items-center position-relative">
                                        <div class="avatar avatar-xs me-2">
                                            <img class="avatar-img  rounded-circle" src="{{ route('/') . current($users->get(['id' => $episode->user_id]))->photo }}" alt="avatar">
                                        </div>
                                        <h6 class="mb-0"><a href="#" class="stretched-link text-reset btn-link">{{ current($users->get(['id' => $episode->user_id]))->first_name . ' ' . current($users->get(['id' => $episode->user_id]))->last_name }}</a></h6>
                                    </div>
                                    <!-- Play Episode -->
                                    <div class="d-xl-flex align-items-center justify-content-between mt-4">
                                        <a class="btn btn-sm btn-primary" href="{{ route('/podcasts/') . $episode->id }}">پخش</a>
