                ...
                <div class="col-lg-9">
                    @foreach($posts as $post)
                        ...
                        <div class="card mb-4">
                            <div class="row">
                                <div class="col-md-5">
                                    <img class="rounded-3" src="{{ route('/') . $post->photo }}" alt="">
                                </div>
                                <div class="col-md-7 mt-3 mt-md-0">
                                    <h4><a href="post-single-2.html" class="btn-link stretched-link text-reset">{{ $post->title }}</a></h4>
                                            ...
                                            <div class="nav-link">
                                                <div class="d-flex align-items-center position-relative">
                                                    <div class="avatar avatar-xs">
                                                        <img class="avatar-img rounded-circle" src="{{ current($users->get(['id' => $post->user_id]))->first_name . ' ' . current($users->get(['id' => $post->user_id]))->last_name }}" alt="avatar">
                                                    </div>
                                                    <span class="ms-3">{{ $lang['by'] }}<a href="#" class="stretched-link text-reset btn-link"></a></span>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="nav-item">{{ $post->date . ' ' . $post->time }}</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 mt-5 mt-lg-0">
                    <div data-sticky data-margin-top="80" data-sticky-for="767">
                        ...
                        <div>
                            ...
                            <!-- Category item -->
                            <div class="text-center mb-3 card-bg-scale position-relative overflow-hidden rounded" style="background-image:url({{ route('/Others/Themes/Frontend/Theme/assets/images') }}/blog/4by3/01.jpg); background-position: center left; background-size: cover;">
