            ...
            <div class="row pb-4">
                <div class="col-12">
                    ...
                    <div class="d-sm-flex justify-content-sm-between align-items-center">
                        <h1 class="mb-2 mb-sm-0 h3">{{ $lang['my-posts'] }} <span
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h6 class="course-title mt-2 mt-md-0 mb-0"><a
                                                            href="{{ route('/panel/posts-management/') . $post->id }}">
                                                        {{ $post->title }}
                                                    </a></h6>
                                            </td>
                                            <!-- Table data -->
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    <a href="{{ route('/panel/my-posts/delete/') . $post->id }}"
                                                       class="btn btn-light btn-round mb-0"
                                                       data-bs-toggle="tooltip" data-bs-placement="top"
                                                       title="{{ $lang['delete'] }}"><i
                                                                class="bi bi-trash"></i></a>
                                                    <a href="{{ route('/panel/my-posts/edit/') . $post->id }}"
                                                       class="btn btn-light btn-round mb-0"
                                                       data-bs-toggle="tooltip" data-bs-placement="top"
                                                       title="{{ $lang['edit'] }}"><i
