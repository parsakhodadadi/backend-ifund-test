            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ $lang['my-posts'] }}</li>
                    </ol>
                </nav>
            </div>
            <div class="ms-auto">
        ...
        @foreach($posts as $post)
            <div class="card">
                <div class="card-body">
                    ...
                    <table>
                        <tr>
                            <td><a class="btn btn-primary" href="{{ route('/panel/my-posts/edit/') . $post->id }}">{{ $lang['edit'] }}</a></td>
                            <td><a class="btn btn-danger" href="{{ route('/panel/my-posts/delete/') . $post->id }}">{{ $lang['delete'] }}</a></td>
                        </tr>
                    </table>
                </div>
            </div>
