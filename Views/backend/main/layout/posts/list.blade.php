            ...
            <div class="row pb-4">
                <div class="col-12">
                    ...
                    <div class="d-sm-flex justify-content-sm-between align-items-center">
                        <h1 class="mb-2 mb-sm-0 h3">{{ $lang['posts-list'] }} <span
                                    class="badge bg-primary bg-opacity-10 text-primary">{{ $postsCount }}</span></h1>
                        <a href="{{ route('/panel/add-post') }}" class="btn btn-sm btn-primary mb-0"><i
                                    class="fas fa-plus me-2"></i>{{ $lang['add-new-post'] }}</a>
                    </div>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="col-sm-4 col-lg-2">
                            ...
                            <div class="card card-body border h-100">
                                ...
                                <div class="ms-0">
                                    ...
                                    <h6 class="mb-0">{{ $lang['text-file'] }}</h6>
                                </div>
                            </div>
                            <!-- Card END -->
                        </div>
                        <div class="col-sm-4 col-lg-2">
                            ...
                            <div class="card card-body border h-100">
                                ...
                                <div class="ms-0">
                                    ...
                                    <h6 class="mb-0">{{ $lang['multi-media'] }}</h6>
                                </div>
                            </div>
                            <!-- Card END -->
                        </div>
                        <div class="col-sm-4 col-lg-2">
                            ...
                            <div class="card card-body border h-100">
                                ...
                                <div class="ms-0">
                                    ...
                                    <h6 class="mb-0">{{ $lang['image-file'] }}</h6>
                                </div>
                            </div>
                            <!-- Card END -->
                        </div>
                        ...
                        <div class="card-body p-3">
                            ...
                            <div class="table-responsive border-0">
                                <table class="table align-middle p-4 mb-0 table-hover table-shrink">
                                    ...
                                    <tr>
                                        <th scope="col" class="border-0 rounded-start">{{ $lang['title'] }}</th>
                                        <th scope="col" class="border-0">{{ $lang['author'] }}</th>
                                        <th scope="col" class="border-0">{{ $lang['publish-date'] }}</th>
                                        <th scope="col" class="border-0">{{ $lang['category'] }}</th>
                                    ...
                                    @foreach($posts as $post)
                                        <tr>
                                            <!-- Table data -->
                                            <td>
                                                <h6 class="course-title mt-2 mt-md-0 mb-0"><a href="{{ route('/panel/posts-management/') . $post->id }}">
                                                        {{ $post->title }}
                                                    </a></h6>
                                            </td>
                                            <!-- Table data -->
                                            <td>
                                                <h6 class="mb-0"><a
                                                            href="#">{{ current($users->get(['id' => $post->user_id]))->first_name . ' ' . current($users->get(['id' => $post->user_id]))->last_name }}</a>
                                                </h6>
                                            </td>
                                            <!-- Table data -->
                                            <td>{{ $post->date }}</td>
                                            ...
                                            <td>
                                                <a href="" class="badge text-bg-warning mb-2"><i
                                                            class="fas fa-circle me-2 small fw-bold"></i>{{ current($categories->get(['id' => $post->post_category_id]))->title }}
                                                </a>
                                            </td>
                                            <!-- Table data -->
                                            <td>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    <a href="{{ route('/panel/posts-management/delete/') . $post->id }}"
                                                       class="btn btn-light btn-round mb-0"
                                                       data-bs-toggle="tooltip" data-bs-placement="top"
                                                       title="{{ $lang['delete'] }}"><i
                                                                class="bi bi-trash"></i></a>
                                                    @if($post->status == 'disapproved')
                                                        <a href="{{ route('/panel/posts-management/approve/') . $post->id }}"
                                                           class="btn btn-light btn-round mb-0"
                                                           data-bs-toggle="tooltip" data-bs-placement="top"
                                                           title="{{ $lang['approve'] }}"><i
                                                                    class="bi-bookmark-check"></i></a>
                                                    @else
                                                        <a href="{{ route('/panel/posts-management/approve/') . $post->id }}"
                                                           class="btn btn-light btn-round mb-0"
                                                           data-bs-toggle="tooltip" data-bs-placement="top"
                                                           title="{{ $lang['deny'] }}"><i
                                                                    class="bi-building-lock"></i></a>
                                                    @endif
                                                </div>
                                            </td>
                                        </tr>
