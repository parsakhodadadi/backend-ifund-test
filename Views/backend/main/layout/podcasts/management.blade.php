...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ route('/Others/Themes/Frontend/Theme/assets/vendor') }}/quill/css/quill.snow.css">
            ...
            <div class="row pb-4">
                <div class="col-12">
                    ...
                    <div class="d-sm-flex justify-content-sm-between align-items-center">
                        <h1 class="mb-2 mb-sm-0 h3">لیست پادکست ها <span class="badge bg-primary bg-opacity-10 text-primary">{{ count($episodes) }}</span></h1>
                        <a href="{{ route('/panel/add-podcast') }}" class="btn btn-sm btn-primary mb-0"><i class="fas fa-plus me-2"></i>ایجاد پادکست جدید</a>
                    </div>
                </div>
            </div>
            <div class="row">
                                ...
                                <table class="table align-middle p-4 mb-0 table-hover table-shrink">
                                    ...
                                    @foreach($episodes as $episode)
                                        ...
                                        <tr>
                                            <!-- Table data -->
                                            <td>
                                                <h6 class="course-title mt-2 mt-md-0 mb-0"><a href="{{ route('/panel/podcasts-management/') . $episode->id }}">{{ $episode->title }}</a></h6>
                                            </td>
                                            <!-- Table data -->
                                            <td>
                                                <h6 class="mb-0"><a href="#">{{ current($users->get(['id' => $episode->user_id]))->first_name . ' ' . current($users->get(['id' => $episode->user_id]))->last_name }}</a></h6>
                                            </td>
                                            <!-- Table data -->
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    <a href="{{ route('/panel/podcasts-management/delete/') . $episode->id }}" class="btn btn-light btn-round mb-0" data-bs-toggle="tooltip" data-bs-placement="top" title="حذف"><i class="bi bi-trash"></i></a>
                                                    @if($episode->status == 'approved')
                                                        <a href="{{ route('/panel/podcasts-management/approve/') . $episode->id }}" class="btn btn-light btn-round mb-0" data-bs-toggle="tooltip" data-bs-placement="top" title="عدم تایید"><i class="bi bi-check-circle"></i></a>
                                                    @else
                                                        <a href="{{ route('/panel/podcasts-management/approve/') . $episode->id }}" class="btn btn-light btn-round mb-0" data-bs-toggle="tooltip" data-bs-placement="top" title="تایید"><i class="bi bi-check-circle"></i></a>
                                                    @endif
                                                </div>
                                            </td>
                                        </tr>
