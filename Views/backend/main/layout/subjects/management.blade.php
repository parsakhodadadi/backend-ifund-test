                    ...
                    <table id="example2" class="table table-striped table-bordered">
                        ...
                        @foreach($subjects as $subject)
                            <tr>
                                ...
                                @endif
                                <td>
                                    <a href="{{ route('/panel/categories-management/'. $category->id .'/subjects/edit/') . $subject->id }}">{{ $lang['edit'] }}</a>
                                    <a href="{{ route('/panel/categories-management/'. $category->id .'/subjects/delete/') . $subject->id }}">{{ $lang['delete'] }}</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
