                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" name="title" class="form-control"
                                                   placeholder="{{ $lang['title'] }}" value="@if(!empty($subject)){{ $subject->title }}@endif"/>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input class="form-control" name="description"
                                                   placeholder="{{ $lang['description'] }}" value="@if(!empty($subject)){{ $subject->description }}@endif"/>
                                    ...
                                    @if($method == 'update')
                                        @if($_SERVER['REQUEST_URI'] == '/ParsaFramework/panel/categories-management/' . $category->id . '/subjects/edit/' . $subject->id  &&  $user->user_type == 'fulladmin')
                                            <div class="row mb-3">
                                                <div class="col-sm-3">
