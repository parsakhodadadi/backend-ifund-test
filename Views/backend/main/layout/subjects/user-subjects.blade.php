            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ $lang['subjects-list'] }}</li>
                    </ol>
                </nav>
            </div>
            <div class="ms-auto">
                    ...
                    <table id="example2" class="table table-striped table-bordered">
                        ...
                        @foreach($subjects as $subject)
                            <tr>
                                ...
                                @endif
                                <td>
                                    <a class="btn btn-primary" href="{{ route('/panel/my-categories/'. $category->id .'/subjects/edit/') . $subject->id }}">{{ $lang['edit'] }}</a>
                                    <a class="btn btn-danger" href="{{ route('/panel/my-categories/'. $category->id .'/subjects/delete/') . $subject->id }}">{{ $lang['delete'] }}</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
