    ...
    <div class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ $lang['add-new-book'] }}</li>
                    </ol>
                </nav>
            </div>
            <div class="ms-auto">
        ...
        <div class="card">
            <div class="card-body p-4">
                <h5 class="card-title">{{ $lang['book-info-form'] }}</h5>
                <hr/>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        @if(!empty($errors['category_id']))
                                            @if(!empty($errors['category_id']['required']))
                                                <div class="form-control alert-danger">{{ $errors['category_id']['required'] }}</div>
                                            @elseif(!empty($errors['category_id']['category_valid']))
                                                <div class="form-control alert-danger">{{ $errors['category_id']['category_valid'] }}</div>
                                            @endif
                                        @endif
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        @if(!empty($errors['files']))
                                            @if(!empty($errors['files']['file_required']))
                                                <div class="form-control alert-danger">{{ $errors['files']['file_required'] }}</div>
                                            @elseif(!empty($errors['files']['photo']))
