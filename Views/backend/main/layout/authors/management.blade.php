...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="card">
            ...
            <table>
                <tr>
                    <td><a class="form-control" href="{{ route('/panel/authors-management/approve/') .  $author->id }}">{{ $lang['approve'] }}</a></td>
                    <td><a class="form-control" href="{{ route('/panel/authors-management/delete/') .  $author->id }}">{{ $lang['delete'] }}</a></td>
                </tr>
            </table>
            @endif
        </div>
