<header class="navbar-light navbar-sticky header-static border-bottom navbar-{{ route('/Others/Themes/Frontend/Theme/') }}dashboard">
    <!-- Logo Nav START -->
    <nav class="navbar navbar-expand-xl">
        <div class="container">
            <!-- Logo START -->
            <a class="navbar-brand me-3" href="{{ route('') }}">
                ...
                <ul class="navbar-nav navbar-nav-scroll mx-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="postMenu">
                            ...
                            <li> <a class="dropdown-item" href="{{ route('/Others/Themes/Frontend/Theme/') }}dashboard-post-categories.html">دسته بندی</a> </li>
            ...
            <div class="nav flex-nowrap align-items-center">
                ...
                <div class="nav-item ms-2 ms-md-3 dropdown">
                    ...
                    <a class="avatar avatar-sm p-0" href="#" id="profileDropdown" role="button" data-bs-auto-close="outside" data-bs-display="static" data-bs-toggle="dropdown" aria-expanded="false">
                        <img class="avatar-img rounded-circle" src="{{ route('/') . $user->photo }}" alt="avatar">
                    </a>
                    ...
                    <ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3" aria-labelledby="profileDropdown">
                        ...
                        <li class="px-3">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="avatar me-3">
                                    <img class="avatar-img rounded-circle shadow" src="{{ route('/') . $user->photo }}" alt="avatar">
                                </div>
                                <div>
                        ...
                        <!-- Links -->
                        <li><a class="dropdown-item" href="{{ route('/panel/edit-profile') }}"><i class="bi bi-person fa-fw me-2"></i>{{ $lang['edit'] }}</a></li>
                        <li><a class="dropdown-item" href="#"><i class="bi bi-gear fa-fw me-2"></i>{{ $lang['settings'] }}</a></li>
                        <li><a class="dropdown-item" href="#"><i class="bi bi-info-circle fa-fw me-2"></i>{{ $lang['guide'] }}</a></li>
                        <li><a class="dropdown-item" href="#"><i class="bi bi-power fa-fw me-2"></i>{{ $lang['logout'] }}</a></li>
