            ...
            <div class="main-body">
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('/panel/users-management/edit-access/') . $user->id }}"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <label type="text" class="form-control">{{ $user->first_name }}</label>
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <label type="text" class="form-control">{{ $user->last_name }}</label>
                                        </div>
                                        <div class="col-sm-3"></div>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                            <h6 class="mb-0">{{ $lang['user_type'] }}</h6>
                                        </div>
                                        <div class="col-sm-9 text-secondary">
                                            <select name="user_type" id="user-type" class="form-select">
                                                @if($user->user_type == "user")
                                                    <option value="user"
                                                            selected="selected">{{ $lang['user'] }}</option>
                                                    <option value="admin">{{ $lang['admin'] }}</option>
                                                @else
                                                    <option value="admin"
                                                            selected="selected">{{ $lang['admin'] }}</option>
                                                    <option value="user">{{ $lang['user'] }}</option>
                                                @endif
                                            </select>
                                        </div>
                                        @if(!empty($errors['user_type']))
                                            <div class="form-control alert-danger">{{ $errors['user_type']['user_type'] }}</div>
                                        @endif
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <select name="blocked" id="user-type" class="form-select">
                                                @if($user->blocked == "yes")
                                                    <option value="yes"
                                                            selected="selected">{{ $lang['blocked'] }}</option>
                                                    <option value="no">{{ $lang['active'] }}</option>
                                                @else
                                                    <option value="no"
                                                            selected="selected">{{ $lang['active'] }}</option>
                                                    <option value="yes">{{ $lang['blocked'] }}</option>
                                                @endif
                                            </select>
                                        </div>
                                        @if(!empty($errors['blocked']))
                                            <div class="form-control alert-danger">{{ $errors['blocked']['blocked'] }}</div>
                                        @endif
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-3"></div>
