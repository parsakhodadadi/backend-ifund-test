        ...
        <div class="container">
                                        ...
                                        <ul class="list-inline">
                                            <li class="list-inline-item"><i class="bi bi-person-fill me-1"></i>
                                                @if($user->user_type == 'user')
                                                    {{ $lang['user'] . ' ' . $lang['aaron-magazine'] }}
                                                @elseif($user->user_type == 'admin')
                                                    {{ $lang['admin'] . ' ' . $lang['aaron-magazine'] }}
                                                @else
                                                    {{ $lang['fulladmin'] . ' ' . $lang['aaron-magazine'] }}
                                                @endif
                                            </li>
                                            ...
                                            <li class="list-inline-item"><i class="bi bi-calendar2-plus me-1"></i>
                                                {{ $lang['subscription_date'] . ' ' . $user->subscription_date }}
                                            </li>
                                        </ul>
                                        <p class="m-0"></p>
                                    </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-7 col-xxl-8">
                    ...
                    <form action="{{ route('/panel/edit-profile') }}" method="post" enctype="multipart/form-data">
                        <div class="card border mb-4">
                            ...
                            @if(!empty($successMessageProfile))
                                <div class="form-control bg-success">{{ $successMessageProfile }}</div>
                            @endif
                        </div>
                    </form>
                    <!-- Profile END -->
                    ...
                    <form action="{{ route('/panel/edit-personal-info') }}" method="post">
                        <div class="card border mb-4">
                            <div class="card-header border-bottom p-3">
                                <h4 class="card-header-title mb-0">{{ $lang['personal-info'] }}</h4>
                            </div>
                            <div class="card-body">
                                <!-- Skype -->
                                <div class="mb-3">
                            ...
                            @if(!empty($successMessagePersonalInfo))
                                <div class="form-control bg-success">{{ $successMessagePersonalInfo }}</div>
                            @endif
                        </div>
                    </form>
                    ...
                    <!-- Social links START -->
                    <form action="{{ route('/panel/edit-social-media') }}" method="post">
                        <div class="card border mb-4">
                            <div class="card-header border-bottom p-3">
                                <h4 class="card-header-title mb-0">{{ $lang['social-media'] }}</h4>
                            </div>
                            <div class="card-body">
                                <!-- Skype -->
                                <div class="mb-3">
                            ...
                            @if(!empty($successMessageSocialMedia))
                                <div class="form-control bg-success">{{ $successMessageSocialMedia }}</div>
                            @endif
                        </div>
                    </form>
                    <!-- Social links END -->
                    ...
                    <form action="{{ route('/panel/change-password') }}" method="post">
                        <div class="card border">
                            <div class="card-header border-bottom p-3">
                                <h4 class="card-header-title mb-0">{{ $lang['change-password'] }}</h4>
                            </div>
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" name="current-password" type="password"
                                           placeholder="*********">
                                    @if(!empty($errors['current-password']))
                                        @if(!empty($errors['current-password']['required']))
                                            <div class="form-control bg-danger">
                                                {{ $errors['current-password']['required'] }}
                                            </div>
                                        @else
                                            <div class="form-control bg-danger">
                                                {{ $errors['current-password']['password'] }}
                                            </div>
                                        @endif
                                    @endif
                                </div>
                                ...
                                <div class="mb-3">
                                    <label class="form-label"
                                           id="psw-strength-message">{{ $lang['new-password'] }}</label>
                                    <div class="input-group">
                  ...
                  <i class="fakepasswordicon far fa-eye cursor-pointer p-2 w-40px"></i>
                                    ...
                                    @if(!empty($errors['new-password']))
                                        @if(!empty($errors['new-password']['required']))
                                            <div class="form-control bg-danger">
                                                {{ $errors['new-password']['required'] }}
                                            </div>
                                        @else
                                            <div class="form-control bg-danger">
                                                {{ $errors['new-password']['password'] }}
                                            </div>
                                        @endif
                                    @endif
                                ...
                                <div>
                                    ...
                                    @if(!empty($errors['confirm-password']))
                                        ...
                                        @else
                                            <div class="form-control bg-danger">
                                                {{ $errors['confirm-password']['password'] }}
                                            </div>
                                        @endif
                                    @endif
                                </div>
                    ...
                    @if(!empty($successMessageChangePassword))
                        <div class="form-control bg-success">{{ $successMessageChangePassword }}</div>
                    @endif
                    @if(!empty($errorMessageChangePassword))
                ...
                <div class="col-lg-5 col-xxl-4">
                    ...
                    <form action="{{ route('/panel/edit-profile-settings') }}" method="post">
                        <div class="card border mb-4">
                            <div class="card-header border-bottom p-3">
                                <h4 class="card-header-title mb-0">{{ $lang['account-settings'] }}</h4>
                            </div>
                            <div class="card-body">
                                <div class="form-check form-switch form-check-md mb-3">
                                    ...
                                    <label class="form-check-label" for="availabilityCheck">{{ $lang['show-profile-every-one'] }}</label>
                                </div>
                                <div class="form-check form-switch form-check-md mb-3">
