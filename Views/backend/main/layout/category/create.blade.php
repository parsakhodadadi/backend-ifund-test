        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<span>
						<h4>
                            ...
                            @elseif($type == 'edit_category')
                                {{ $lang['edit-category'] }}
                            @elseif($type == 'add_sub_category')
                                {{ $lang['add-sub-category'] }}
                            @elseif($type == 'edit_sub_category')
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" name="title" class="form-control"
                                                   placeholder="{{ $lang['title'] }}" value="@if(!empty($data)){{ $data->title }}@endif"/>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input class="form-control" name="description"
                                                   placeholder="{{ $lang['description'] }}" value="@if(!empty($data)){{ $data->description }}@endif"/>
