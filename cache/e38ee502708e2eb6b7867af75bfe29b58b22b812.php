                ...
                <div class="col-lg-8">
                    ...
                    <div class="card border rounded-3 p-3 mb-4">
                        <div class="row g-4">
                            ...
                            <div class="col-md-5">
                                <div class="position-relative">
                                    <img class="rounded-3" src="<?php echo e(route('/Others/Themes/Frontend/Theme/assets/images')); ?>/blog/4by3/32.jpg" alt="Card image">
                                </div>
                            </div>
                            <div class="col-md-7">
                                <div class="d-flex justify-content-between mb-2">
                    ...
                    <div class="card border rounded-3 p-3 mb-4">
                        <div class="row g-4">
                            ...
                            <div class="col-md-5">
                                <div class="position-relative">
                                    <img class="rounded-3" src="<?php echo e(route('/Others/Themes/Frontend/Theme/assets/images')); ?>/blog/4by3/33.jpg" alt="Card image">
                                </div>
                            </div>
                            <div class="col-md-7">
                                <div class="d-flex justify-content-between mb-2">
                                ...
                                <div class="d-xl-flex align-items-center justify-content-between mt-4">
                                    ...
                                    <ul class="list-unstyled d-flex gap-2 align-items-center">
                                        ...
                                        <li><a href="#"> <img class="h-20" src="<?php echo e(route('/Others/Themes/Frontend/Theme/assets/images')); ?>/icon/divider-icon.svg" alt=""> </a></li>
                                        <li><a href="#"> <img class="h-20" src="<?php echo e(route('/Others/Themes/Frontend/Theme/assets/images')); ?>/icon/spotify.svg" alt=""> </a></li>
                                        <li><a href="#"> <img class="h-20" src="<?php echo e(route('/Others/Themes/Frontend/Theme/assets/images')); ?>/icon/google-podcasts.svg" alt=""> </a></li>
                                        <li><a href="#"> <img class="h-20" src="<?php echo e(route('/Others/Themes/Frontend/Theme/assets/images')); ?>/icon/sound-cloud.svg" alt=""> </a></li>
                                    </ul>
                                </div>
                            </div>
...
</html><?php /**PATH /Applications/MAMP/htdocs/ParsaFramework/views/frontend/main/podcast-page.blade.php ENDPATH**/ ?>