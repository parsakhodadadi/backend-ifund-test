...
<head>
	...
	<!--plugins-->
	<link href="<?php echo e(route('Others/Themes/Backend/main/vertical/')); ?>assets/plugins/simplebar/css/simplebar.css" rel="stylesheet" />
...
<body class="rtl">
	...
	<div class="wrapper">
		...
		<div class="sidebar-wrapper" data-simplebar="true">
			...
			<!--navigation-->
			<?php echo e($view->make('Backend/main/layout/navigation' , ['menus'=>$menus])); ?>
...
//$myRouter->route(1, 'panelTest', 'login', 'userController@panelTEST'); ?><?php /**PATH /Applications/MAMP/htdocs/ParsaFramework/Views/Backend/main/index.blade.php ENDPATH**/ ?>