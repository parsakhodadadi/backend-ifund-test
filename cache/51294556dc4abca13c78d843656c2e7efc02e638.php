            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="example2" class="table table-striped table-bordered">
                        ...
                        <tr>
                            <th>
                                <strong><?php echo e($lang['row']); ?></strong>
                            </th>
                        ...
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <?php else: ?>
                                    <td>
                                        <h6 class=""><?php echo e($lang['disapproved']); ?></h6>
                                    </td>
                                <?php endif; ?>
                                <td>
                                    <a class="btn btn-primary"
                                       href="<?php echo e(route('/panel/my-categories/edit/') . $category->id); ?>"><?php echo e($lang['edit']); ?></a>
                                    <a class="btn btn-danger"
                                       href="<?php echo e(route('/panel/my-categories/delete/') . $category->id); ?>"><?php echo e($lang['delete']); ?></a>
                                </td>
                                <td>
                                    <?php if($category->status == 'approved'): ?>
                                        <a class="btn btn-primary"
                                           href="<?php echo e(route('/panel/my-categories/') . $category->id . '/add-subject'); ?>">+</a>
                                        <a class="btn btn-dark"
                                           href="<?php echo e(route('/panel/my-categories/') . $category->id . '/subjects'); ?>"><?php echo e($lang['list']); ?></a>
                                    <?php endif; ?>
                                </td>
                            </tr>
...
<?php /**PATH /Applications/MAMP/htdocs/ParsaFramework/views/backend/main/layout/categories/user-categories.blade.php ENDPATH**/ ?>