...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasMenu">
    ...
    <div class="offcanvas-body d-flex flex-column pt-0">
        <div>
            <img class="light-mode-item my-3" src="<?php echo e(route('/Others/Themes/Frontend/Theme/assets/images/')); ?>logo.svg" alt="logo">
            <img class="dark-mode-item my-3" src="<?php echo e(route('/Others/Themes/Frontend/Theme/assets/images/')); ?>logo-light.svg" alt="logo">
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            ...
            <a class="navbar-brand" href="<?php echo e(route('/Others/Themes/Frontend/Theme/')); ?>index.html">
                <img class="navbar-brand-item light-mode-item" src="<?php echo e(route('/Others/Themes/Frontend/Theme/assets/images/')); ?>logo.svg" alt="logo">
                <img class="navbar-brand-item dark-mode-item" src="<?php echo e(route('/Others/Themes/Frontend/Theme/assets/images/')); ?>logo-light.svg" alt="logo">
            </a>
            <!-- Logo END -->
                ...
                <ul class="navbar-nav navbar-nav-scroll mx-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="pagesMenu">
                            ...
                            <li>
                                <a class="dropdown-item" href="<?php echo e(route('/Others/Themes/Frontend/Theme/')); ?>docs/index.html" target="_blank">
                                ...
                                <div class="row g-4 p-3 flex-fill">
                                    ...
                                    <div class="col-sm-6 col-lg-3">
                                        <div class="card bg-transparent">
                                            <!-- Card img -->
                                            <img class="card-img rounded" src="<?php echo e(route('/Others/Themes/Frontend/Theme/assets/images/')); ?>blog/16by9/small/01.jpg" alt="Card image">
                                    ...
                                    <div class="col-sm-6 col-lg-3">
                                        <div class="card bg-transparent">
                                            <!-- Card img -->
                                            <img class="card-img rounded" src="<?php echo e(route('/Others/Themes/Frontend/Theme/assets/images/')); ?>blog/16by9/small/02.jpg" alt="Card image">
                                            <div class="card-body px-0 pt-3">
                                    ...
                                    <div class="col-sm-6 col-lg-3">
                                        <div class="card bg-transparent">
                                            <!-- Card img -->
                                            <img class="card-img rounded" src="<?php echo e(route('/Others/Themes/Frontend/Theme/assets/images/')); ?>blog/16by9/small/03.jpg" alt="Card image">
                                            <div class="card-body px-0 pt-3">
    ...
    <section class="pt-4 pb-0 card-grid">
        <div class="container">
            <div class="row g-4">
                <!-- Left big card -->
                <div class="col-lg-6">
                    <div class="card card-overlay-bottom card-grid-lg card-bg-scale" style="background-image:url(<?php echo e(route('/Others/Themes/Frontend/Theme/assets/images/')); ?>blog/1by1/01.jpg); background-position: center left; background-size: cover;">
                        <!-- Card featured -->
                        ...
                        <div class="card-img-overlay d-flex align-items-center p-3 p-sm-4">
                            <div class="w-100 mt-auto">
                                ...
                                <!-- Card title -->
                                <h2 class="text-white h1"><a href="<?php echo e(route('/Others/Themes/Frontend/Theme/')); ?>post-single-4.html" class="btn-link stretched-link text-reset">ده نشانه که نشان می دهد برای راه اندازی یک استارتاپ جدید به آن نیاز دارید.</a></h2>
                                        ...
                                        <div class="nav-link">
                                            <div class="d-flex align-items-center text-white position-relative">
                                                <div class="avatar avatar-sm">
                                                    <img class="avatar-img rounded-circle" src="<?php echo e(route('/Others/Themes/Frontend/Theme/assets/images/')); ?>avatar/11.jpg" alt="avatar">
                                                </div>
                ...
                <div class="col-lg-6">
                    <div class="row g-4">
                        <!-- Card item START -->
                        <div class="col-12">
                            <div class="card card-overlay-bottom card-grid-sm card-bg-scale" style="background-image:url(<?php echo e(route('/Others/Themes/Frontend/Theme/assets/images/')); ?>blog/1by1/02.jpg); background-position: center left; background-size: cover;">
                                <!-- Card Image -->
                                <!-- Card Image overlay -->
                                <div class="card-img-overlay d-flex align-items-center p-3 p-sm-4">
                                    <div class="w-100 mt-auto">
                                        ...
                                        <!-- Card title -->
                                        <h4 class="text-white"><a href="<?php echo e(route('/Others/Themes/Frontend/Theme/')); ?>post-single-4.html" class="btn-link stretched-link text-reset">بهترین تابلوهای Pinterest برای یادگیری در مورد تجارت</a></h4>
                                        <!-- Card info -->
                                        <ul class="nav nav-divider text-white-force align-items-center d-none d-sm-inline-block">
                        ...
                        <!-- Card item START -->
                        <div class="col-md-6">
                            <div class="card card-overlay-bottom card-grid-sm card-bg-scale" style="background-image:url(<?php echo e(route('/Others/Themes/Frontend/Theme/assets/images/')); ?>blog/1by1/03.jpg); background-position: center left; background-size: cover;">
                                <!-- Card Image overlay -->
                                <div class="card-img-overlay d-flex align-items-center p-3 p-sm-4">
                                    <div class="w-100 mt-auto">
                                        <!-- Card category -->
                                        ...
                                        <!-- Card title -->
                                        <h4 class="text-white"><a href="<?php echo e(route('/Others/Themes/Frontend/Theme/')); ?>post-single-4.html" class="btn-link stretched-link text-reset">دلیل کاهش نرخ دلار </a></h4>
                                        <!-- Card info -->
                                        <ul class="nav nav-divider text-white-force align-items-center d-none d-sm-inline-block">
                                            <li class="nav-item position-relative">
                        ...
                        <!-- Card item START -->
                        <div class="col-md-6">
                            <div class="card card-overlay-bottom card-grid-sm card-bg-scale" style="background-image:url(<?php echo e(route('/Others/Themes/Frontend/Theme/assets/images/')); ?>blog/1by1/04.jpg); background-position: center left; background-size: cover;">
                                <!-- Card Image overlay -->
                                <div class="card-img-overlay d-flex align-items-center p-3 p-sm-4">
                                    <div class="w-100 mt-auto">
                                        <!-- Card category -->
                                        ...
                                        <!-- Card title -->
                                        <h4 class="text-white"><a href="<?php echo e(route('/Others/Themes/Frontend/Theme/')); ?>post-single-4.html" class="btn-link stretched-link text-reset">جدول لیگ در پایان هفته</a></h4>
                                        <!-- Card info -->
                                        <ul class="nav nav-divider text-white-force align-items-center d-none d-sm-inline-block">
                                            <li class="nav-item position-relative">
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <!-- Card img -->
                                <div class="position-relative">
                                    <img class="card-img" src="<?php echo e(route('/Others/Themes/Frontend/Theme/assets/images/')); ?>blog/4by3/01.jpg" alt="Card image">
                                ...
                                <div class="card-body px-0 pt-3">
                                    ...
                                    <h4 class="card-title mt-2"><a href="<?php echo e(route('/Others/Themes/Frontend/Theme/')); ?>post-single.html" class="btn-link text-reset">فیلم‌های بالیوودی الگوی ضدانقلاب شده!</a></h4>
                                            ...
                                            <div class="nav-link">
                                                <div class="d-flex align-items-center position-relative">
                                                    <div class="avatar avatar-xs">
                                                        <img class="avatar-img rounded-circle" src="<?php echo e(route('/Others/Themes/Frontend/Theme/assets/images/')); ?>avatar/01.jpg" alt="avatar">
                                                    </div>
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <!-- Card img -->
                                <div class="position-relative">
                                    <img class="card-img" src="<?php echo e(route('/Others/Themes/Frontend/Theme/assets/images/')); ?>blog/4by3/06.jpg" alt="Card image">
                                    <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                                        <!-- Card overlay Top -->
                                ...
                                <div class="card-body px-0 pt-3">
                                    <h4 class="card-title"><a href="<?php echo e(route('/Others/Themes/Frontend/Theme/')); ?>post-single.html" class="btn-link text-reset">رازهای کوچک کثیف در مورد صنعت تجارت</a></h4>
                                    ...
                                    <ul class="nav nav-divider align-items-center d-none d-sm-inline-block">
                                        <li class="nav-item">
                                            <div class="nav-link">
                                                <div class="d-flex align-items-center position-relative">
                                                    <div class="avatar avatar-xs">
                                                        <img class="avatar-img rounded-circle" src="<?php echo e(route('/Others/Themes/Frontend/Theme/assets/images/')); ?>avatar/02.jpg" alt="avatar">
                                                    </div>
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <!-- Card img -->
                                <div class="position-relative">
                                    <img class="card-img" src="<?php echo e(route('/Others/Themes/Frontend/Theme/assets/images/')); ?>blog/4by3/03.jpg" alt="Card image">
                                    <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                                        <!-- Card overlay bottom -->
                                        <div class="w-100 mt-auto">
                                            <!-- Card category -->
                                ...
                                <div class="card-body px-0 pt-3">
                                    <h4 class="card-title"><a href="<?php echo e(route('/Others/Themes/Frontend/Theme/')); ?>post-single.html" class="btn-link text-reset">عادات بدی که افراد در صنعت باید آنها را ترک کنند!!!</a></h4>
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <!-- Card img -->
                                <div class="position-relative">
                                    <img class="card-img" src="<?php echo e(route('/Others/Themes/Frontend/Theme/assets/images/')); ?>blog/4by3/04.jpg" alt="Card image">
                                    <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                                        <!-- Card overlay bottom -->
                                        <div class="w-100 mt-auto">
                                            <!-- Card category -->
                                ...
                                <div class="card-body px-0 pt-3">
                                    <h4 class="card-title"><a href="<?php echo e(route('/Others/Themes/Frontend/Theme/')); ?>post-single.html" class="btn-link text-reset">سال 2022 رویایی و فوق العاده برای طارمی</a></h4>
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <!-- Card img -->
                                <div class="position-relative">
                                    <!-- <img class="card-img" src="<?php echo e(route('/Others/Themes/Frontend/Theme/assets/images/')); ?>blog/4by3/05.jpg" alt="Card image"> -->
                                            ...
                                            <div class="w-100 my-auto">
                                                ...
                                                <div class="player-wrapper bg-light rounded">
                                                    <audio class="player-audio" crossorigin>
                                                        <source src="<?php echo e(route('/Others/Themes/Frontend/Theme/assets/images/')); ?>videos/audio.mp3" type="audio/mp3">
                                                    </audio>
                                                </div>
                                                <!-- Audio END -->
                                            </div>
                                ...
                                <div class="card-body px-0 pt-3">
                                    <h4 class="card-title"><a href="<?php echo e(route('/Others/Themes/Frontend/Theme/')); ?>post-single.html" class="btn-link text-reset">طرح مجلس برای گرفتن مالیات از سفته بازها</a></h4>
                                    ...
                                    <ul class="nav nav-divider align-items-center d-none d-sm-inline-block">
                                        <li class="nav-item">
                                            <div class="nav-link">
                                                <div class="d-flex align-items-center position-relative">
                                                    <div class="avatar avatar-xs">
                                                        <img class="avatar-img rounded-circle" src="<?php echo e(route('/Others/Themes/Frontend/Theme/assets/images/')); ?>avatar/05.jpg" alt="avatar">
                                                    </div>
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <!-- Card img -->
                                <div class="position-relative">
                                    <img class="card-img" src="<?php echo e(route('/Others/Themes/Frontend/Theme/assets/images/')); ?>blog/4by3/12.jpg" alt="Card image">
                                    <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                                        <!-- Card overlay bottom -->
                                        <div class="w-100 mt-auto">
                                            <!-- Card category -->
                                ...
                                <div class="card-body px-0 pt-3">
                                    <h4 class="card-title"><a href="<?php echo e(route('/Others/Themes/Frontend/Theme/')); ?>post-single.html" class="btn-link text-reset">رونمایی از طرح بزرگترین تلسکوپ نوری آسیا</a></h4>
                                    ...
                                    <ul class="nav nav-divider align-items-center d-none d-sm-inline-block">
                                        <li class="nav-item">
                                            <div class="nav-link">
                                                <div class="d-flex align-items-center position-relative">
                                                    <div class="avatar avatar-xs">
                                                        <img class="avatar-img rounded-circle" src="<?php echo e(route('/Others/Themes/Frontend/Theme/assets/images/')); ?>avatar/06.jpg" alt="avatar">
                                                    </div>
                ...
                <div class="col-lg-3 mt-5 mt-lg-0">
                    <div data-sticky data-margin-top="80" data-sticky-for="767">
                        ...
                        <div>
                            ...
                            <!-- Category item -->
                            <div class="text-center mb-3 card-bg-scale position-relative overflow-hidden rounded bg-dark-overlay-4 " style="background-image:url(<?php echo e(route('/Others/Themes/Frontend/Theme/assets/images/')); ?>blog/4by3/01.jpg); background-position: center left; background-size: cover;">
                                <div class="p-3">
                            ...
                            <div class="col-12 col-sm-6 col-lg-12">
                                ...
                                <div class="card mb-3">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-8">
                                            <h6><a href="<?php echo e(route('/Others/Themes/Frontend/Theme/')); ?>post-single-2.html" class="btn-link stretched-link text-reset">خرید و فروش ارز در کانال 37 هزار تومانی</a></h6>
                                ...
                                <div class="card mb-3">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-8">
                                            <h6><a href="<?php echo e(route('/Others/Themes/Frontend/Theme/')); ?>post-single-2.html" class="btn-link stretched-link text-reset">کاهش 192 هزار میلیارد تومانی بدهی دولت</a></h6>
                                ...
                                <div class="card mb-3">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-8">
                                            <h6><a href="<?php echo e(route('/Others/Themes/Frontend/Theme/')); ?>post-single-2.html" class="btn-link stretched-link text-reset">ساخت مسکن موتور محرک کاهش تورم</a></h6>
                                ...
                                <div class="card mb-3">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-8">
                                            <h6><a href="<?php echo e(route('/Others/Themes/Frontend/Theme/')); ?>post-single-2.html" class="btn-link stretched-link text-reset">آشنایی با کلید موفقیت نهضت ملی مسکن‌</a></h6>
...
<footer class="bg-dark pt-5">
    <div class="container">
        ...
        <div class="row pt-3 pb-4">
            <div class="col-md-3">
                <img src="<?php echo e(route('/Others/Themes/Frontend/Theme/assets/images/')); ?>logo-footer.svg" alt="footer logo">
            </div>
            <div class="col-md-5">
        ...
        <div class="row pt-5">
            ...
            <div class="col-md-6 col-lg-3 mb-4">
                ...
                <div class="mb-4 position-relative">
                    ...
                    <a href="<?php echo e(route('/Others/Themes/Frontend/Theme/')); ?>post-single-3.html" class="btn-link text-white fw-normal">تقویم آزمون‌های علوم پزشکی</a>
                ...
                <div class="mb-4 position-relative">
                    ...
                    <a href="<?php echo e(route('/Others/Themes/Frontend/Theme/')); ?>post-single-3.html" class="btn-link text-white fw-normal">احتمال آغاز موج هشتم کرونا در کشور</a>
                    <ul class="nav nav-divider align-items-center small mt-2 text-muted">
                        <li class="nav-item position-relative">
            ...
            <div class="col-sm-6 col-lg-3 mb-4">
                ...
                <div class="row g-2">
                    <div class="col">
                        <a href="#"><img class="w-100" src="<?php echo e(route('/Others/Themes/Frontend/Theme/assets/images/')); ?>app-store.svg" alt="app-store"></a>
                    </div>
                    <div class="col">
                        <a href="#"><img class="w-100" src="<?php echo e(route('/Others/Themes/Frontend/Theme/assets/images/')); ?>google-play.svg" alt="google-play"></a>
                    </div>
                </div>
            </div>
        </div>
