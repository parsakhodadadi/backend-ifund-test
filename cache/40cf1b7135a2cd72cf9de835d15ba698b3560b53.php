                    ...
                    <div class="p-4 p-sm-5 bg-primary bg-opacity-10 rounded">
                        ...
                        <form class="mt-4" action="<?php echo e(route('/sign-in')); ?>" method="post">
                            ...
                            <div class="mb-3 form-check">
                                ...
                                <label class="form-check-label" for="exampleCheck1"><?php echo e($lang['remember-me']); ?></label>
                            </div>
                            <!-- Button -->
                        ...
                        <div class="text-center">
                            <p><?php echo e($lang['sign-in-with-social-media']); ?></p>
                            <ul class="list-unstyled d-sm-flex mt-3 justify-content-center">
                                <li class="mx-2">
                                    <a href="#" class="btn bg-facebook d-inline-block"><i class="fab fa-facebook-f me-2"><?php echo e($lang['sign-in-facebook']); ?></i>
                                    </a>
                                </li>
                                <li class="mx-2">
                                    <a href="#" class="btn bg-google d-inline-block"><i class="fab fa-google me-2"><?php echo e($lang['sign-in-google']); ?></i>
                                    </a>
                                </li>
                            </ul>
                        </div>
...
</html><?php /**PATH /Applications/MAMP/htdocs/ParsaFramework/Views/frontend/sign-in/user-password-sign-in.blade.php ENDPATH**/ ?>