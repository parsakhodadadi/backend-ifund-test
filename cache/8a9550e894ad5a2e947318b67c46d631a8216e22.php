            ...
            <div class="row pb-4">
                <div class="col-12">
                    ...
                    <div class="d-sm-flex justify-content-sm-between align-items-center">
                        <h1 class="mb-2 mb-sm-0 h3">لیست پادکست ها <span class="badge bg-primary bg-opacity-10 text-primary"><?php echo e(count($episodes)); ?></span></h1>
                        <a href="<?php echo e(route('/panel/add-podcast')); ?>" class="btn btn-sm btn-primary mb-0"><i class="fas fa-plus me-2"></i>ایجاد پادکست جدید</a>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="row g-4 mb-4">
                        ...
                        <div class="col-sm-4 col-lg-2">
                            ...
                            <div class="card card-body border h-100">
                                ...
                                <!-- Content -->
                                <div class="ms-0">
                                    <h3 class="mb-0"><?php echo e(count($episodes)); ?></h3>
                            ...
                            <div class="table-responsive border-0">
                                <table class="table align-middle p-4 mb-0 table-hover table-shrink">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="border-0">نام سازنده</th>
                                    ...
                                    <?php $__currentLoopData = $episodes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $episode): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            <!-- Table data -->
                                            <td>
                                                <h6 class="course-title mt-2 mt-md-0 mb-0"><a href="<?php echo e(route('/panel/podcasts-management/') . $episode->id); ?>"><?php echo e($episode->title); ?></a></h6>
                                            </td>
                                            <!-- Table data -->
                                            <td>
                                                <h6 class="mb-0"><a href="#"><?php echo e(current($users->get(['id' => $episode->user_id]))->first_name . ' ' . current($users->get(['id' => $episode->user_id]))->last_name); ?></a></h6>
                                            </td>
                                            <!-- Table data -->
                                            <td><?php echo e($episode->date . ' ' . $episode->time); ?></td>
                                            <!-- Table data -->
                                            <td>
                                                <?php if($episode->status == 'approved'): ?>
                                                    <span class="badge bg-success bg-opacity-10 text-success mb-2">تایید شده</span>
                                                <?php elseif($episode->status == 'pre-written'): ?>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    <a href="<?php echo e(route('/panel/podcasts-management/delete/') . $episode->id); ?>" class="btn btn-light btn-round mb-0" data-bs-toggle="tooltip" data-bs-placement="top" title="حذف"><i class="bi bi-trash"></i></a>
                                                    <?php if($episode->status == 'approved'): ?>
                                                        <a href="<?php echo e(route('/panel/podcasts-management/approve/') . $episode->id); ?>" class="btn btn-light btn-round mb-0" data-bs-toggle="tooltip" data-bs-placement="top" title="عدم تایید"><i class="bi bi-check-circle"></i></a>
                                                    <?php else: ?>
                                                        <a href="<?php echo e(route('/panel/podcasts-management/approve/') . $episode->id); ?>" class="btn btn-light btn-round mb-0" data-bs-toggle="tooltip" data-bs-placement="top" title="تایید"><i class="bi bi-check-circle"></i></a>
                                                    <?php endif; ?>
                                                </div>
                                            </td>
                                        </tr>
...
</html><?php /**PATH /Applications/MAMP/htdocs/ParsaFramework/Views/backend/main/layout/podcasts/management.blade.php ENDPATH**/ ?>