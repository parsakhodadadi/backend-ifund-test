                ...
                <div class="col-12">
                    ...
                    <div class="d-sm-flex justify-content-sm-between align-items-center">
                        <h1 class="mb-2 mb-sm-0 h3">لیست پادکست ها <span
                                    class="badge bg-primary bg-opacity-10 text-primary"><?php echo e(count($episodes)); ?></span>
                        </h1>
                        <a href="<?php echo e(route('/panel/add-podcast')); ?>" class="btn btn-sm btn-primary mb-0"><i
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h6 class="course-title mt-2 mt-md-0 mb-0"><a
                                                            href="<?php echo e(route('/panel/my-podcasts/') . $episode->id); ?>"><?php echo e($episode->title); ?></a>
                                                </h6>
                                            </td>
                                            <!-- Table data -->
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    <a href="<?php echo e(route('/panel/my-podcasts/delete/') . $episode->id); ?>"
                                                       class="btn btn-light btn-round mb-0" data-bs-toggle="tooltip"
                                                       data-bs-placement="top" title="حذف"><i
                                                                class="bi bi-trash"></i></a>
                                                    <a href="<?php echo e(route('/panel/my-podcasts/edit/') . $episode->id); ?>"
                                                       class="btn btn-light btn-round mb-0" data-bs-toggle="tooltip"
...
</html><?php /**PATH /Applications/MAMP/htdocs/ParsaFramework/Views/backend/main/layout/podcasts/user-podcasts.blade.php ENDPATH**/ ?>