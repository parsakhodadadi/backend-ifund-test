                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" name="title" class="form-control"
                                                   placeholder="<?php echo e($lang['title']); ?>" value="<?php if(!empty($subject)): ?><?php echo e($subject->title); ?><?php endif; ?>"/>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input class="form-control" name="description"
                                                   placeholder="<?php echo e($lang['description']); ?>" value="<?php if(!empty($subject)): ?><?php echo e($subject->description); ?><?php endif; ?>"/>
                                    ...
                                    <?php if($method == 'update'): ?>
                                        <?php if($_SERVER['REQUEST_URI'] == '/ParsaFramework/panel/categories-management/' . $category->id . '/subjects/edit/' . $subject->id  &&  $user->user_type == 'fulladmin'): ?>
                                            <div class="row mb-3">
                                                <div class="col-sm-3">
...
<?php /**PATH /Applications/MAMP/htdocs/ParsaFramework/views/backend/main/layout/subjects/create.blade.php ENDPATH**/ ?>