                    ...
                    <div class="bg-primary bg-opacity-10 rounded p-4 p-sm-5">
                        ...
                        <div class="text-center">
                            ...
                            <ul class="list-unstyled d-sm-flex mt-3 justify-content-center">
                                <li class="mx-2">
                                    <a href="#" class="btn bg-facebook d-inline-block"><i class="fab fa-facebook-f me-2"></i><?php echo e($lang['sign-in-facebook']); ?></a>
                                </li>
                                <li class="mx-2">
                                    <a href="#" class="btn bg-google d-inline-block"><i class="fab fa-google me-2"></i><?php echo e($lang['sign-in-google']); ?></a>
                                </li>
                            </ul>
                        </div>
                    </div>
...
</html><?php /**PATH /Applications/MAMP/htdocs/ParsaFramework/views/frontend/sign-up/sign-up-form.blade.php ENDPATH**/ ?>