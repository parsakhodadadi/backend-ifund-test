                    ...
                    <table id="example2" class="table table-striped table-bordered">
                        ...
                        <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <?php endif; ?>
                                <td>
                                    <a href="<?php echo e(route('/panel/categories-management/'. $category->id .'/subjects/edit/') . $subject->id); ?>"><?php echo e($lang['edit']); ?></a>
                                    <a href="<?php echo e(route('/panel/categories-management/'. $category->id .'/subjects/delete/') . $subject->id); ?>"><?php echo e($lang['delete']); ?></a>
                                </td>
                            </tr>
...
<?php /**PATH /Applications/MAMP/htdocs/ParsaFramework/views/backend/main/layout/subjects/management.blade.php ENDPATH**/ ?>