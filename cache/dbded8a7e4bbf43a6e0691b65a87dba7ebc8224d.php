                        ...
                        <table>
                            <tr>
                                <?php if($book->status == 'disapproved'): ?>
                                    <td><a class="form-control" href="<?php echo e(route('/panel/management/books/approve/') .  $book->id); ?>"><?php echo e($lang['approve']); ?></a></td>
                                <?php endif; ?>
                                <td><a class="form-control" href="<?php echo e(route('/panel/management/books/delete/') .  $book->id); ?>"><?php echo e($lang['delete']); ?></a></td>
                            </tr>
                        </table>
                </div>
...
<?php /**PATH /Applications/MAMP/htdocs/ParsaFramework/views/backend/main/layout/books/list.blade.php ENDPATH**/ ?>