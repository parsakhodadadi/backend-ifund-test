            ...
            <div class="container">
                <div class="main-body">
                    <div class="row">
                        ...
                        <form action="<?php echo route('/admin/category/list/edit/') . $category->id; ?>" method="post">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row mb-3">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <input class="form-control" name="description" value="<?php echo e($category->description); ?>" />
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <input type="text" name = "tags" class="form-control" value="<?php echo e($category->tags); ?>" />
                                                <?php if(!empty($errors['tags'])): ?>
                                                    <div class="alert-danger"><?php echo ($errors['tags']['required']); ?></div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
...
</html><?php /**PATH /Applications/MAMP/htdocs/ParsaFramework/views/backend/main/layout/category/edit.blade.php ENDPATH**/ ?>