    ...
    <section class="py-4">
        <div class="container">
            <div class="row pb-4">
                <div class="col-12">
                    <!-- Title -->
                    <h1 class="mb-0 h3"><?php echo e($lang['create-new-category']); ?></h1>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
...
</html><?php /**PATH /Applications/MAMP/htdocs/ParsaFramework/views/backend/main/layout/post-categories/create.blade.php ENDPATH**/ ?>