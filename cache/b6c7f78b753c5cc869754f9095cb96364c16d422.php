            ...
            <div class="row pb-4">
                <div class="col-12">
                    ...
                    <div class="d-sm-flex justify-content-sm-between align-items-center">
                        <h1 class="mb-2 mb-sm-0 h3"><?php echo e($lang['categories-list']); ?> <span
                        ...
                        <a href="#" class="btn btn-sm btn-primary mb-0"><i
                                    class="fas fa-plus me-2"></i><?php echo e($lang['create-new-category']); ?></a>
                    </div>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="card-body p-3">
                            ...
                            <div class="table-responsive border-0">
                                <table class="table align-middle p-4 mb-0 table-hover table-shrink">
                                    ...
                                    <tr>
                                        <th scope="col" class="border-0 rounded-start"><?php echo e($lang['category-title']); ?></th>
                                        <th scope="col" class="border-0"><?php echo e($lang['description']); ?></th>
                                    ...
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            <!-- Table data -->
                                            <td>
                                                <h6 class="course-title mt-2 mt-md-0 mb-0"><a href="#"><?php echo e($category->title); ?></a></h6>
                                            </td>
                                            <!-- Table data -->
                                            <td>
                                                <p>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    <a href="<?php echo e(route('/panel/posts-categories-management/delete/') . $category->id); ?>" class="btn btn-light btn-round mb-0"
                                                       data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo e($lang['delete']); ?>"><i
                                                                class="bi bi-trash"></i></a>
                                                    <a href="<?php echo e(route('/panel/posts-categories-management/edit/') . $category->id); ?>" class="btn btn-light btn-round mb-0"
                                                       data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo e($lang['edit']); ?>"><i
...
</html><?php /**PATH /Applications/MAMP/htdocs/ParsaFramework/views/backend/main/layout/post-categories/management.blade.php ENDPATH**/ ?>