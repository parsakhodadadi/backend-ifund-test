    ...
    <div class="container" data-sticky-container>
        <div class="row">
            ...
            <div class="col-lg-9">
                <!-- Title -->
                <div class="mb-4">
                    <h2 class="m-0"><i class="bi bi-hourglass-top me-2"></i><?php echo e(__('main-front.other-important-posts')); ?></h2>
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                ...
                                <div class="card-body px-0 pt-3">
                                    ...
                                    <h4 class="card-title mt-2"><a href="<?php echo e(route('/Others/Themes/Frontend/Theme/')); ?>post-single.html" class="btn-link text-reset"><?php echo e($post->title); ?></a></h4>
...
</section><?php /**PATH /Applications/MAMP/htdocs/ParsaFramework/views/frontend/main/other-posts.blade.php ENDPATH**/ ?>