            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><?php echo e($lang['subjects-list']); ?></li>
                    </ol>
                </nav>
            </div>
            <div class="ms-auto">
                ...
                <div class="table-responsive">
                    <table id="example2" class="table table-striped table-bordered">
                        ...
                        <tr>
                            ...
                            <th><?php echo e($lang['subjects-settings']); ?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php ($row = 0); ?>
                        <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <?php endif; ?>
                                <td>
                                    <a class="btn btn-primary" href="<?php echo e(route('/panel/my-categories/'. $category->id .'/subjects/edit/') . $subject->id); ?>"><?php echo e($lang['edit']); ?></a>
                                    <a class="btn btn-danger" href="<?php echo e(route('/panel/my-categories/'. $category->id .'/subjects/delete/') . $subject->id); ?>"><?php echo e($lang['delete']); ?></a>
                                </td>
                            </tr>
...
<?php /**PATH /Applications/MAMP/htdocs/ParsaFramework/views/backend/main/layout/subjects/user-subjects.blade.php ENDPATH**/ ?>