                ...
                <div class="col-lg-8">
                    ...
                    <div class="card border h-100">
                        ...
                        <div class="card-header border-bottom d-flex justify-content-between align-items-center p-3">
                            <h4 class="card-header-title mb-0"><?php echo e($lang['about-user']); ?></h4>
                        </div>
                            ...
                            <div class="d-sm-flex justify-content-sm-between align-items-center mb-4">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="avatar avatar-lg">
                                        <img class="avatar-img rounded-circle border border-white border-3 shadow" src="<?php echo e(route('/') . $user->photo); ?>" alt="">
                                    </div>
                                    <!-- Info -->
                                    <div class="ms-3">
                                        <h5 class="mb-0"><?php echo e($user->first_name . ' ' . $user->last_name); ?></h5>
                                        <p class="mb-0 small">
                                            <?php if($user->user_type == 'user'): ?>
                                                <?php echo e($lang['user'] . ' ' . $lang['site']); ?>

                                            <?php elseif($user->user_type == 'admin'): ?>
                                                <?php echo e($lang['admin'] . ' ' . $lang['site']); ?>

                                            <?php else: ?>
                                                <?php echo e($lang['fulladmin'] . ' ' . $lang['site']); ?>
                                ...
                                <div class="d-flex mt-2 mt-sm-0">
                                    <h6 class="bg-danger py-2 px-3 text-white rounded"><?php echo e($user->followers . ' ' . $lang['followerr']); ?></h6>
                                    <h6 class="bg-info py-2 px-3 text-white rounded ms-2"><?php echo e(count($posts->get()) . ' ' . $lang['post']); ?></h6>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <ul class="list-group list-group-borderless">
                                        ...
                                        <!-- Full Name -->
                                        <li class="list-group-item">
                                            <span><?php echo e($lang['full-name:']); ?></span>
                                            <span class="h6 mb-0"><?php echo e($user->first_name . ' ' . $user->last_name); ?></span>
                                        </li>
                                        <!-- User Name -->
                                        <li class="list-group-item">
                                            <span><?php echo e($lang['username:']); ?></span>
                                            <span class="h6 mb-0"><?php echo e($user->username); ?></span>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <ul class="list-group list-group-borderless">
                                        <!-- Email ID -->
                                        <li class="list-group-item">
                                            <span><?php echo e($lang['email:']); ?></span>
                                            <span class="h6 mb-0"><?php echo e($user->email); ?></span>
                                        </li>
                                        <!-- Mobile Number -->
                                        <li class="list-group-item">
                                        ...
                                        <!-- Joining Date -->
                                        <li class="list-group-item">
                                            <span><?php echo e($lang['subscription-date:']); ?></span>
                                            <span class="h6 mb-0"><?php echo e($user->subscription_date); ?></span>
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <div class="card border h-100">
                        ...
                        <div class="card-body p-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="d-flex align-items-center position-relative">
                                        <img class="w-60 rounded" src="<?php echo e(route('/Others/Themes/Frontend/Theme/assets/images')); ?>/blog/1by1/04.jpg" alt="product">
                                        <div class="ms-3">
...
</html><?php /**PATH /Applications/MAMP/htdocs/ParsaFramework/Views/backend/main/layout/users/user-single.blade.php ENDPATH**/ ?>