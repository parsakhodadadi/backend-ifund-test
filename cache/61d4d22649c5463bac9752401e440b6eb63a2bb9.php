										...
										<form class="row g-3" action="<?php echo route(''); ?>register">
											<div class="col-sm-6">
												...
												<input type="text" class="form-control" id="inputFirstName"
													placeholder="<?php echo e($lang['ex-first-name']); ?>" name="firstname">
											</div>
											<div class="col-sm-6">
												<label for="inputLastName" class="form-label"><?php echo e($lang['last-name']); ?></label>
												<input type="text" class="form-control" id="inputLastName"
													placeholder="<?php echo e($lang['ex-last-name']); ?>" name="lastname">
											</div>
											<div class="col-12">
											...
											<div class="col-12">
												<div class="d-grid">
													<button type="submit" class="btn btn-primary"><i
															class='bx bx-user'></i><?php echo e($lang['register']); ?></button>
												</div>
											</div>
										</form>
									</div>
