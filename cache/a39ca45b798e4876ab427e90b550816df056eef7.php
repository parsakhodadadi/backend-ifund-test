    ...
    <div class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><?php echo e($lang['add-new-book']); ?></li>
                    </ol>
                </nav>
            </div>
            <div class="ms-auto">
        ...
        <div class="card">
            <div class="card-body p-4">
                <h5 class="card-title"><?php echo e($lang['book-info-form']); ?></h5>
                <hr/>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <?php if(!empty($errors['category_id'])): ?>
                                            <?php if(!empty($errors['category_id']['required'])): ?>
                                                <div class="form-control alert-danger"><?php echo e($errors['category_id']['required']); ?></div>
                                            <?php elseif(!empty($errors['category_id']['category_valid'])): ?>
                                                <div class="form-control alert-danger"><?php echo e($errors['category_id']['category_valid']); ?></div>
                                            <?php endif; ?>
                                        <?php endif; ?>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <?php if(!empty($errors['files'])): ?>
                                            <?php if(!empty($errors['files']['file_required'])): ?>
                                                <div class="form-control alert-danger"><?php echo e($errors['files']['file_required']); ?></div>
                                            <?php elseif(!empty($errors['files']['photo'])): ?>
...
<?php /**PATH /Applications/MAMP/htdocs/ParsaFramework/views/backend/main/layout/books/create.blade.php ENDPATH**/ ?>