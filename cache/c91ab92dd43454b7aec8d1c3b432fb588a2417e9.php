            ...
            <div class="row pb-4">
                <div class="col-12">
                    ...
                    <div class="d-sm-flex justify-content-sm-between align-items-center">
                        <h1 class="mb-2 mb-sm-0 h3"><?php echo e($lang['posts-list']); ?> <span
                            ...
                            <div class="table-responsive border-0">
                                <table class="table align-middle p-4 mb-0 table-hover table-shrink">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="border-0"><?php echo e($lang['author']); ?></th>
                                    ...
                                    <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <!-- Table data -->
                                            <td>
                                                <h6 class="course-title mt-2 mt-md-0 mb-0"><a href="<?php echo e(route('/panel/posts-management/') . $post->id); ?>">
                                            ...
                                            <td>
                                                <h6 class="mb-0"><a
                                                            href="#"><?php echo e(current($users->get(['id' => $post->user_id]))->first_name . ' ' . current($users->get(['id' => $post->user_id]))->last_name); ?></a>
                                                </h6>
                                            </td>
                                            <!-- Table data -->
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    <a href="<?php echo e(route('/panel/posts-management/delete/') . $post->id); ?>"
                                                       class="btn btn-light btn-round mb-0"
                                                       data-bs-toggle="tooltip" data-bs-placement="top"
                                                       title="<?php echo e($lang['delete']); ?>"><i
                                                                class="bi bi-trash"></i></a>
                                                    <?php if($post->status == 'disapproved'): ?>
                                                        <a href="<?php echo e(route('/panel/posts-management/approve/') . $post->id); ?>"
                                                           class="btn btn-light btn-round mb-0"
                                                           data-bs-toggle="tooltip" data-bs-placement="top"
                                                           title="<?php echo e($lang['approve']); ?>"><i
                                                                    class="bi-bookmark-check"></i></a>
                                                    <?php else: ?>
                                                        <a href="<?php echo e(route('/panel/posts-management/approve/') . $post->id); ?>"
                                                           class="btn btn-light btn-round mb-0"
                                                           data-bs-toggle="tooltip" data-bs-placement="top"
                                                           title="<?php echo e($lang['deny']); ?>"><i
...
</html><?php /**PATH /Applications/MAMP/htdocs/ParsaFramework/views/backend/main/layout/posts/management.blade.php ENDPATH**/ ?>