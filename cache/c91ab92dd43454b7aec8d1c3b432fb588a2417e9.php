            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><?php echo e($lang['posts-management']); ?></li>
                    </ol>
                </nav>
            </div>
            <div class="ms-auto">
                ...
                <div class="card-body">
                    <?php if(!empty($user_id)): ?>
                        <?php if($post->user_id == $user_id): ?>
                            <a href="<?php echo e(route('/panel/admin/posts/edit/') . $post->id); ?>"
                               class="form-control"><?php echo e($lang['edit']); ?></a>
                        <?php endif; ?>
                    <?php endif; ?>
                        ...
                        <tr>
                            <?php if($post->status == 'disapproved'): ?>
                                <td><a class="btn btn-success"
                                       href="<?php echo e(route('/panel/posts-management/approve/') . $post->id); ?>"><?php echo e($lang['approve']); ?></a>
                                </td>
                            <?php endif; ?>
                            <td><a class="btn btn-danger"
                                   href="<?php echo e(route('/panel/posts-management/delete/') . $post->id); ?>"><?php echo e($lang['delete']); ?></a>
                            </td>
                        </tr>
                    </table>
                </div>
...
<?php /**PATH /Applications/MAMP/htdocs/ParsaFramework/views/backend/main/layout/posts/management.blade.php ENDPATH**/ ?>