            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><?php echo e($lang['my-posts']); ?></li>
                    </ol>
                </nav>
            </div>
            <div class="ms-auto">
        ...
        <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="card">
                <div class="card-body">
                    ...
                    <table>
                        <tr>
                            <td><a class="btn btn-primary" href="<?php echo e(route('/panel/my-posts/edit/') . $post->id); ?>"><?php echo e($lang['edit']); ?></a></td>
                            <td><a class="btn btn-danger" href="<?php echo e(route('/panel/my-posts/delete/') . $post->id); ?>"><?php echo e($lang['delete']); ?></a></td>
                        </tr>
                    </table>
                </div>
            </div>
...
<?php /**PATH /Applications/MAMP/htdocs/ParsaFramework/views/backend/main/layout/posts/admin-posts.blade.php ENDPATH**/ ?>