        ...
        <div class="container position-relative" data-sticky-container>
            <div class="row">
                ...
                <div class="col-lg-2">
                    <div class="text-start text-lg-center mb-5" data-sticky data-margin-top="80" data-sticky-for="991">
                        ...
                        <ul class="list-inline list-unstyled">
                            ...
                            <li class="list-inline-item d-lg-block my-lg-2"><i class="far fa-eye me-1"></i><?php echo e($post->views); ?> بازدید
                            </li>
                        </ul>
                        <!-- Tags -->
                            ...
                            <?php if(!empty($post->tags)): ?>
                                ...
                                <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="list-inline-item">
                                        <a class="text-body" href="#">#<?php echo e($tag); ?></a>
                                    </li>
                ...
                <div class="col-lg-7 mb-5">
                    ...
                    <div>
                        <h3>
                            <?php echo e(count($comments) + count($replyComments->get()) . ' ' . __('comments.comment')); ?>
