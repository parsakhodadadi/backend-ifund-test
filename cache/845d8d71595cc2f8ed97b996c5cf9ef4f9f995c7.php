            ...
            <div class="row g-4 pb-4">
                <div class="col-12">
                    <div class="d-sm-flex justify-content-between align-items-center">
                        <h1 class="mb-sm-0 h3"><?php echo e($lang['users-list']); ?></h1>
                                ...
                                <div class="tab-pane fade show active" id="nav-list-tab">
                                    ...
                                    <div class="table-responsive border-0">
                                        <table class="table align-middle p-4 mb-0 table-hover">
                                            ...
                                            <tr>
                                                <th scope="col" class="border-0 rounded-start"><?php echo e($lang['user-full-name']); ?></th>
                                                <th scope="col" class="border-0"><?php echo e($lang['user-type']); ?></th>
                                                <th scope="col" class="border-0"><?php echo e($lang['subscription-date']); ?></th>
                                                <th scope="col" class="border-0"><?php echo e($lang['posts-count']); ?></th>
                                                <th scope="col" class="border-0"><?php echo e($lang['followers']); ?></th>
                                            ...
                                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center position-relative">
                                                            ...
                                                            <div class="avatar avatar-md">
                                                                <img src="<?php echo e(route('/') . $user->photo); ?>" class="rounded-circle" alt="">
                                                            </div>
                                                            <div class="mb-0 ms-2">
                                                                <!-- Title -->
                                                                <h6 class="mb-0"><a href="<?php echo e(route('/panel/users-management/') . $user->id); ?>" class="stretched-link"><?php echo e($user->first_name . ' ' . $user->last_name); ?></a></h6>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <!-- Table data -->
                                                    <td><?php echo e($user->subscription_date); ?></td>
                                                    <!-- Table data -->
                                                    <td><?php echo e(count($posts->get(['user_id' => $user->id]))); ?></td>
                                                    <!-- Table data -->
                                                    <td><?php echo e($user->followers); ?></td>
                                                    <!-- Table data -->
                                                    <td>
                                                        <?php if($user->blocked == 'yes'): ?>
                                                            <span class="badge bg-danger bg-opacity-10 text-danger mb-2"><?php echo e($lang['blocked']); ?></span>
                                                        <?php else: ?>
                                                            <span class="badge bg-success bg-opacity-10 text-success mb-2"><?php echo e($lang['active']); ?></span>
                                                        <?php endif; ?>
                                                    </td>
                                                    <!-- Table data -->
                                                    <td>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="d-flex align-items-center justify-content-between">
                                                            ...
                                                            <div class="avatar avatar-lg me-3 flex-shrink-0">
                                                                <img class="avatar-img rounded-circle" src="<?php echo e(route('/') . $user->photo); ?>" alt="">
                                                            </div>
                                                            <!-- Connections holder -->
                                                            <div class="flex-grow-1 d-block">
                                                                <h5 class="mb-1"><a href="#"><?php echo e($user->first_name . ' ' . $user->last_name); ?></a></h5>
                                                                <div class="small">
                                                                    <?php if($user->user_type == 'user'): ?>
                                                                        <?php echo e($lang['user']); ?>
                                                        ...
                                                        <div class="d-sm-flex justify-content-sm-between mt-3">
                                                            ...
                                                            <div class="d-flex text-start align-items-center mt-3">
                                                                ...
                                                                <div class="ms-2">
                                                                    <h5 class="mb-0"><?php echo e($user->followers); ?></h5>
                                                                    <h6 class="mb-0 fw-light"><?php echo e($lang['follower']); ?></h6>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="d-flex text-start align-items-center mt-3">
                                                                ...
                                                                <div class="ms-2">
                                                                    <h5 class="mb-0"><?php echo e(count($posts->get(['user_id' => $user->id]))); ?></h5>
                                                                    <h6 class="mb-0 fw-light"><?php echo e($lang['posts-count']); ?></h6>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="d-sm-flex gap-2 mt-4">
                                                            <a href="#" class="btn btn-primary-soft w-100">
                                                                <i class="fab fa-facebook-messenger pe-2"></i><?php echo e($lang['send-message']); ?>

                                                            </a>
                                                            <a href="<?php echo e(route('/panel/users-management/block/') . $user->id); ?>" class="btn btn-danger-soft w-100">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center position-relative">
                                                <!-- Image -->
                                                <div class="avatar avatar-md">
                                                    <img src="<?php echo e(route('/Others/Themes/Frontend/Theme/assets/images')); ?>/avatar/04.jpg" class="rounded-circle" alt="">
                                                </div>
                                                <div class="mb-0 ms-2">
                                                    <!-- Title -->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center position-relative">
                                                <!-- Image -->
                                                <div class="avatar avatar-md">
                                                    <img src="<?php echo e(route('/Others/Themes/Frontend/Theme/assets/images')); ?>/avatar/05.jpg" class="rounded-circle" alt="">
                                                </div>
                                                <div class="mb-0 ms-2">
                                                    <!-- Title -->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center position-relative">
                                                <!-- Image -->
                                                <div class="avatar avatar-md">
                                                    <img src="<?php echo e(route('/Others/Themes/Frontend/Theme/assets/images')); ?>/avatar/06.jpg" class="rounded-circle" alt="">
                                                </div>
                                                <div class="mb-0 ms-2">
                                                    <!-- Title -->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center position-relative">
                                                <!-- Image -->
                                                <div class="avatar avatar-md">
                                                    <img src="<?php echo e(route('/Others/Themes/Frontend/Theme/assets/images')); ?>/avatar/07.jpg" class="rounded-circle" alt="">
                                                </div>
                                                <div class="mb-0 ms-2">
                                                    <!-- Title -->
...
</html><?php /**PATH /Applications/MAMP/htdocs/ParsaFramework/Views/backend/main/layout/users/management.blade.php ENDPATH**/ ?>